...
const styles = StyleSheet.create({
  ...
  notifContent: { flex: 1 },
  notifTitle: { fontSize: 14, fontFamily: "Raleway-SemiBold" },
  notifBody: { fontSize: 13, fontFamily: "Raleway-Regular", marginTop: 2, lineHeight: 18 },
  notifTime: { fontSize: 11, fontFamily: "Raleway-Regular", marginTop: 4 },
  ...
  emptyTitle: { fontSize: 18, fontWeight: "700", fontFamily: "Raleway-Bold", marginBottom: 8 },
  emptySubtitle: { fontSize: 14, fontFamily: "Raleway-Regular", textAlign: "center", lineHeight: 20 },
});
