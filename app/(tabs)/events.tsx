...
const styles = StyleSheet.create({
  ...
  dateFilterRow: { paddingHorizontal: 16, paddingTop: 6, paddingBottom: 6 },
  ...
  chipsContainer: { paddingHorizontal: 16, paddingTop: 4, paddingBottom: 14, gap: 8, flexDirection: "row", alignItems: "center" },
