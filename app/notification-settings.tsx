...
const styles = StyleSheet.create({
  ...
  permissionTitle: { fontSize: 15, fontWeight: "700", fontFamily: "Raleway-Bold" },
  permissionSub: { fontSize: 12, marginTop: 2, fontFamily: "Raleway-Regular" },
  section: { marginHorizontal: 16, marginTop: 16, borderRadius: 14, borderWidth: 1, overflow: "hidden" },
  sectionTitle: { fontSize: 15, fontWeight: "700", paddingHorizontal: 16, paddingTop: 16, paddingBottom: 4, fontFamily: "Raleway-Bold" },
  sectionSub: { fontSize: 12, paddingHorizontal: 16, paddingBottom: 8, fontFamily: "Raleway-Regular" },
  settingRow: { flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingVertical: 14 },
  settingIcon: { width: 36, height: 36, borderRadius: 10, alignItems: "center", justifyContent: "center" },
  settingTitle: { fontSize: 14, fontWeight: "600", fontFamily: "Raleway-SemiBold" },
  settingDesc: { fontSize: 12, marginTop: 2, fontFamily: "Raleway-Regular" },
  actionRow: { flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingVertical: 14 },
  infoText: { fontSize: 12, lineHeight: 18, textAlign: "center", fontFamily: "Raleway-Regular" },
});
