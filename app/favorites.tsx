...
export default function FavoritesScreen() {
  ...
  const { favorites, favoriteEvents, favoriteProducts, removeFavorite } =
    useFavorites();
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={[styles.emptySubText, { color: colors.muted }]}>
              Appuyez sur le coeur pour sauvegarder vos événements et produits
              préférés
            </Text>
          </View>
        }
