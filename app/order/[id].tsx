...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 15, fontWeight: "700", paddingHorizontal: 16, paddingTop: 16, paddingBottom: 8 },
  ...
  noteText: { fontSize: 13, lineHeight: 20, paddingHorizontal: 16, paddingBottom: 16 },
});
