      ...
      >
        ...
        >
          ...
          <Text style={styles.pointsValue}>
            {state.availablePoints.toLocaleString("fr-FR")}
          </Text>
          {canRedeem ? (
            <Text style={styles.pointsSub}>
              ={" "}
              {getDiscountValue(state.availablePoints).toLocaleString("fr-FR")}{" "}
              Ar de réduction
            </Text>
          ) : (
            <View
            ...
            >
              ...
              >
                Encore {pointsUntilRedemption.toLocaleString("fr-FR")} pts pour
                débloquer l'échange
              </Text>
            </View>
          )}
          ...
          <View style={styles.statsRow}>
            <View style={styles.statItem}>
              <Text style={styles.statValue}>
                {state.lifetimePoints.toLocaleString("fr-FR")}
              </Text>
        ...
        >
          ...
          <View style={styles.howItWorksGrid}>
            ...
            <View style={styles.howItem}>
              <View
                style={[styles.howIcon, { backgroundColor: "#FFD700" + "20" }]}
              >
        ...
        >
          <View style={styles.priorityEyebrow}>
            ...
            <Text style={styles.priorityEyebrowText}>
              NOUVEAU POUR LES MEMBRES GOLD+
            </Text>
          </View>
          <Text style={styles.priorityTitle}>
            Votre statut peut vous faire gagner du temps
          </Text>
          <Text style={styles.priorityCopy}>
            ...
            kiosque, mais ne remplace jamais le contrôle et la validité du
            billet.
          </Text>
          ...
          {TIERS.map((tier, idx) => (
            <View
              ...
              style={[
                ...
                {
                  backgroundColor:
                    tier.id === state.tier ? tier.color + "15" : colors.surface,
                  borderColor:
                    tier.id === state.tier ? tier.color : colors.border,
                },
              ]}
            >
              <View style={styles.tierCardHeader}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={[styles.tierMin, { color: colors.muted }]}>
                    {tier.minPoints === 0
                      ? "Niveau de départ"
                      : `${tier.minPoints.toLocaleString("fr-FR")} pts requis`}
                  </Text>
                </View>
                {tier.id === state.tier && (
                  <View
