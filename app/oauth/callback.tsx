  ...
  useEffect(() => {
    const handleCallback = async () => {
      try {
        ...
        if (params.sessionToken) {
          ...
          if (params.user) {
            try {
              ...
              // The session token remains authoritative when optional user data is malformed.
            }
          }
        ...
        if (!code || !state) {
          setStatus("error");
          setErrorMessage("La connexion n'a pas pu être vérifiée.");
          return;
        }
        ...
        if (result.sessionToken) {
          ...
          setStatus("error");
          setErrorMessage("La connexion n'a pas retourné de session valide.");
        }
      } catch (error) {
        setStatus("error");
        setErrorMessage(
