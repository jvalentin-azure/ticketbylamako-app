...
| `EXPO_PUBLIC_GOOGLE_MAPS_API_KEY`      | Public Google Maps browser key restricted to the required Maps API and TicketByLamako applications. Configure it in EAS; do not hardcode it in source. | `(configured in EAS)`              |
