...
function lr_shortcode_rewards_page_v4() {
    ...
    <main id="lamako-rewards-v4" class="lrv4">
        ...
        <section class="lrv4-hero">
            <div><img class="lrv4-logo" src="<?php echo esc_url( $logo ); ?>" alt="LamakoRewards"><br><span class="lrv4-kicker">Vos sorties vous récompensent</span><h1>Plus de moments.<br>Plus de valeur.</h1><p class="lrv4-lead">Un programme simple et transparent: gagnez sur vos achats éligibles, suivez votre solde et utilisez vos points dès 500.</p><div class="lrv4-actions"><a class="lrv4-button" href="/mobile/login">Ouvrir LamakoRewards</a><a class="lrv4-button alt" href="/conditions-lamakorewards/">Voir les conditions</a></div></div>
        </section>
